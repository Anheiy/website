...
<div className="flex flex-col h-full  font-Jersey25">
    ...
    <div className="text-xl text-zinc-700 mt-4 ml-4">Other Interests...</div>
    <div className="space-y-2 ml-4">
        <div className="flex space-x-2"><Resource name="Cooking!" bgcolor="bg-orange-500"/></div>
        <div className="flex space-x-2">Cooking is what I do when my brain is too exhausted to code. Can be a very easy to do thing that feels productive!</div>
        ...
        <div className="flex space-x-2">Indie media is so important, whether it be games to film. 
                                        ...
                                        Either way they are interesting art pieces! 
                                        If you are interested in ones I liked:
                                        </div>
                                        <div className="flex space-x-2">
                                            <ol className="list-disc">
                                                ...
                                                <li>Lasagna Cat: its garfield arg... really well done</li>
        ...
        <div className="flex space-x-2">I've always actively seeked out new skills.
                                        ...
                                        I am much more of a journey over the endgoal person. I've learned how to cook, code, 3D Model, 3D animate, making games almost all by myself!
        </div>
        ...
        <div className="flex space-x-2">I think autochess strike just the right balance of skill and rng. The ability to relinquish control to your units and how you've placed them is satisfying to me</div>
        <div className="flex space-x-2"><Resource name="Coding!" bgcolor="bg-lime-500"/></div>
        <div className="flex space-x-2">Coding is a very theraputic hobby for me, it activates my neurons! I've been coding for around 5 years now and I really do love doing it.</div>
    </div>
