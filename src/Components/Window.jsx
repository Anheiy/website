...
function Window({ id, title, x, y, visible, content, onToggle, width, height, z =1}) {
    ...
    return (
        <div id={id} ref={setNodeRef} style={style} className="w-window h-window rounded-xl bg-zinc-200 touch-none shadow-slate-800 shadow-2xl border-black border-2 overflow-hidden">
